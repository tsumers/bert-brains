...
if 'slumlordreach' in data_dir:
	layer_dir='/jukebox/griffiths/bert-brains/code/bert-brains/data/slumlordreach/bert-base-uncased/syntactic_analyses/slumlordreach_bert-base-uncased_zrep_magnitudes.npy'
	...
	layer_dir='/jukebox/griffiths/bert-brains/code/bert-brains/data/black/bert-base-uncased/syntactic_analyses/black_bert-base-uncased_zrep_magnitudes.npy'
	...
	#print(raw_features.shape,raw_primary_features.shape)
			...
			for zero_head in range(144):
				if zero_head!=head:
					for d in range(4): 
						start=zero_head  
						offset=186*d   
						hnum_coef[:,offset+start:offset+start+1]=0.0   
						#start=zero_head+144 
						#hnum_coef[:,offset+start:offset+start+1]=0.0     
